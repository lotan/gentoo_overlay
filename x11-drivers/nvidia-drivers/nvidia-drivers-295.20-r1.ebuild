...
# $Header: /var/cvsroot/gentoo-x86/x11-drivers/nvidia-drivers/nvidia-drivers-295.20-r1.ebuild,v 1.2 2012/03/19 18:53:54 cardoe Exp $
...
src_prepare() {
	...
	EOF
	epatch "${FILESDIR}"/compile-linux-3.3.patch
}
