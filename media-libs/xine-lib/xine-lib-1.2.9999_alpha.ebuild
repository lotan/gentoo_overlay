...
#EHG_REVISION=$(echo ${PR}|sed 's/^r//')
#EHG_REVISION=4ebb4e398f40 # Merge from 1.1; resync translation files.
#EHG_REVISION=037d98bcf08f # Merge from 1.1.
EHG_REVISION=03d01d484189 # Merge from 1.1. (including pa patches)
