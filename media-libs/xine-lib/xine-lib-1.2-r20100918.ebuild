...
DESCRIPTION="Core libraries for Xine movie player - Media player back end (1.2; unstable development branch)"
SRC_URI="http://my"
SRC_URI="http://my/xine-lib-1.2-20100918.tar.bz2"
...
debug modplug -gtk pulseaudio -mmap truetype vdpau wavpack +musepack +xcb jack
real vdr"
...
#   epatch "${FILESDIR}"/volume_feedback.patch
#   epatch "${FILESDIR}"/logarithmic_volume.patch
#   epatch "${FILESDIR}"/mad_accept_more_on_pts.patch
   epatch "${FILESDIR}"/mad_more2less.patch

   epatch "${FILESDIR}"/resample-debug.patch
   epatch "${FILESDIR}"/pulse-debug.patch
#   epatch "${FILESDIR}"/audio_out-debug.patch
#   epatch "${FILESDIR}"/audio_out-debug2.patch

   epatch "${FILESDIR}"/pulse_low_latency_buffers.patch
#   epatch "${FILESDIR}"/pulse_low_latency.patch
#   epatch "${FILESDIR}"/pulse_low_latency_debug.patch
#   epatch "${FILESDIR}"/pulse_buffer_attr.patch

#   epatch "${FILESDIR}"/pulse_buffer_attr2.patch
#   epatch "${FILESDIR}"/audio_out-fifo.patch
#   epatch "${FILESDIR}"/audio_out-fifo2.patch

#   epatch "${FILESDIR}"/audio_out-fifo3.patch

#   epatch "${FILESDIR}"/mad_log.patch
#   epatch "${FILESDIR}"/alsa-debug.patch
#   epatch "${FILESDIR}"/alsa-debug2.patch
#   epatch "${FILESDIR}"/alsa-debug3.patch
