...
#   epatch "${FILESDIR}"/audio_decoder_log.patch
#   epatch "${FILESDIR}"/metronome_log.patch
#   epatch "${FILESDIR}"/audio_out_log.patch
#   epatch "${FILESDIR}"/video_out_log.patch
#   epatch "${FILESDIR}"/video_out_vdpau_no_lockdisplay.patch
