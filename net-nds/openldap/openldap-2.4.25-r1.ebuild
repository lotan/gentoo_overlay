...
# $Header: /var/cvsroot/gentoo-x86/net-nds/openldap/openldap-2.4.25-r1.ebuild,v 1.7 2012/02/21 00:19:44 robbat2 Exp $
...
src_configure() {
	...
	if ! use minimal ; then
		...
		for backend in dnssrv ldap meta monitor null passwd relay shell sock rwm; do
